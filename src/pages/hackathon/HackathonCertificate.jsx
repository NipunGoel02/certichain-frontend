            ...
            <div className="mb-8 p-4 bg-gray-50 rounded-lg">
              ...
              >
                ...
                <div className="text-center mb-6">
                  <h2 className="text-3xl font-bold text-purple-800 mb-1">Certificate of Participation</h2>
                ...
                <div className="text-center mb-8">
                  ...
                  <h4 className="text-xl font-bold text-purple-700 mt-2">"{hackathon.title}"</h4>
                </div>
